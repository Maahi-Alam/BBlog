            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        <div class="post-thumb">
                            <img src="{{ $first_posts->featured }}" alt="{{ $first_posts->title }}">
                            <div class="overlay"></div>
                            <a href="{{ $first_posts->featured }}" class="link-image js-zoom-image">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center">
                                        <a href="{{ route('post.single', ['slug' => $first_posts->slug ]) }}">{{ $first_posts->title }}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                                {{ $first_posts->created_at->toFormattedDateString() }}
                                            </time>
