                  ...
                  <main class="main">
                        ...
                        <div class="blog-details-author">
                              ...
                              <div class="blog-details-author-thumb">
                                    <img src="{{ asset($post->user->profiles->avatar) }}" alt="Author">
                              </div>
                              ...
                              <div class="blog-details-author-content">
                                    ...
                                    <p class="text">{{ $post->user->profiles->about }}
                                    </p>
                                    <div class="socials">

                                    <a href="{{ $post->user->profiles->facebook }}" class="social__item" target="_blank">
                                          <img src="{{ asset('app/svg/circle-facebook.svg') }}" alt="facebook">
                                    </a>

                                    <a href="{{ $post->user->profiles->youtube }}" class="social__item" target="_blank">
